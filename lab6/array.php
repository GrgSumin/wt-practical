...
$arr3 = array("S1"=>"Sumin", "S2"=>"Dipesh", "S3"=>"Sanjaya", "S4"=>"Ajit", "S5"=>"Bibek", "S6"=>"Nishanta");
asort($arr3);
...
$arr4 = array("S1"=>"Sumin", "S2"=>"Dipesh", "S3"=>"Sanjaya", "S4"=>"Ajit", "S5"=>"Bibek", "S6"=>"Nishanta");
arsort($arr4);
